...
def items() -> list[dict]:
    ...
    out.append({"类": OPEN, "项": "消融判决表已补工况并拆词, **但只覆盖 17.3%**",
                "证据": ("★ 2026-09-06 两轮消融(88 agent)后重判, 见 tests/data/ablation_verdicts_v2.json。"
                         ...
                         "★ 仍未完成: ① 覆盖率**文件级仅 17.3%**(6274/36211 行), 三块结构性空白 —— "
